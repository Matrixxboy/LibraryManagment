        ...
        <footer className="bg-dark"> 
            <div className="container"> 
                <div className="row justify-content-center">
                    ...
                    <div className="col-12 col-md-4 mb-3"> 
                            <div className="center text-center"> 
                                <h5 className="title text-white"><FontAwesomeIcon icon={faDiscord} className="me-1" />Discord</h5>
                                <p className="text-white">A platform for community building and real-time communication via text, voice, and video.</p>
